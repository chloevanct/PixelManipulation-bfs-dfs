...
// TEST_CASE("colorPicker::extra negative border test", "[weight=1][part=colorPicker]")
// {

//     cout << "Entered colorPicker::extra negative border test..." << endl;
...
//     PNG result = testColorPicker(negborderPicker);
//     result.convert();
//     result.writeToFile("images-output/negativeBorderColorPickerEXTRATest.png");
...
TEST_CASE("colorPicker::basic solid", "[weight=0][part=colorPicker]")
{
    ...
    PNG expected;
    expected.readFromFile("images-soln/ex-solidColorPickerTest.png");
...
TEST_CASE("colorPicker::basic image tile", "[weight=1][part=colorPicker]")
{
    ...
    PNG expected;
    expected.readFromFile("images-soln/ex-imageTileColorPickerTest.png");
    REQUIRE(result == expected);
...
TEST_CASE("colorPicker::basic quarter", "[weight=1][part=colorPicker]")
{
    ...
    PNG result = testColorPicker(quarterPicker);
    result.convert();
...
TEST_CASE("colorPicker::basic negative border", "[weight=1][part=colorPicker]")
{
    ...
    PNG expected;
    expected.readFromFile("images-soln/ex-negativeBorderColorPickerTest.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic solid dfs", "[weight=1][part=fill]")
{
    ...
    PNG result = anim.write("images-output/dfssolid.gif");
    result.convert();
    result.writeToFile("images-output/dfssolid.png");

    PNG expected;
    expected.readFromFile("images-soln/ex-dfssolid.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic solid bfs", "[weight=1][part=fill]")
{
    ...
    PNG result = anim.write("images-output/bfssolid.gif");
    result.convert();
    result.writeToFile("images-output/bfssolid.png");

    PNG expected;
    expected.readFromFile("images-soln/ex-bfssolid.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic image tile dfs", "[weight=1][part=fill]")
{
    ...
    PNG result = anim.write("images-output/dfsimagetile.gif");
    result.convert();
    result.writeToFile("images-output/dfsimagetile.png");

    PNG expected;
    expected.readFromFile("images-soln/ex-dfsimagetile.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic image tile bfs", "[weight=1][part=fill]")
{
    ...
    PNG result = anim.write("images-output/bfsimagetile.gif");
    result.convert();
    result.writeToFile("images-output/bfsimagetile.png");

    PNG expected;
    expected.readFromFile("images-soln/ex-bfsimagetile.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic quarter dfs", "[weight=1][part=fill]")
{
    ...
    PNG result = anim.write("images-output/dfsquarter.gif");
    result.convert();
    result.writeToFile("images-output/dfsquarter.png");

    PNG expected;
    expected.readFromFile("images-soln/ex-dfsquarter.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic quarter bfs", "[weight=1][part=fill]")
{
    ...
    PNG result = anim.write("images-output/bfsquarter.gif");
    result.convert();
    result.writeToFile("images-output/bfsquarter.png");

    PNG expected;
    expected.readFromFile("images-soln/ex-bfsquarter.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic negative border dfs", "[weight=1][part=fill]")
{
    ...
    PNG result = anim.write("images-output/dfsnegativeborder.gif");
    result.convert();
    result.writeToFile("images-output/dfsnegativeborder.png");

    PNG expected;
    expected.readFromFile("images-soln/ex-dfsnegativeborder.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic negative border bfs", "[weight=1][part=fill]")
{
    ...
    PNG result = anim.write("images-output/bfsnegativeborder.gif");
    result.convert();
    result.writeToFile("images-output/bfsnegativeborder.png");

    PNG expected;
    expected.readFromFile("images-soln/ex-bfsnegativeborder.png");
    REQUIRE(result == expected);
